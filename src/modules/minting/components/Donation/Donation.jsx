...
const Donation = () => {
  const [nears, setNears] = useState(0);
  ...
  return (
    <div className='donation'>
      <span className='donation__text'>Donate</span>

      <div className='donation__input'>
        <Input type='number' value={nears} onChange={handleNears} />
      </div>
      ...
      <span className='donation__text'>for food</span>
    </div>
  );
};
